...
// MV Calibration.cpp: 定義應用程式的類別表現方式。
//
...
BEGIN_MESSAGE_MAP(CMVCalibrationApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// CMVCalibrationApp 建構

CMVCalibrationApp::CMVCalibrationApp()
{
	// 支援重新啟動管理員
...
// 唯一一個 CMVCalibrationApp 物件

CMVCalibrationApp theApp;


// CMVCalibrationApp 初始化

BOOL CMVCalibrationApp::InitInstance()
{
