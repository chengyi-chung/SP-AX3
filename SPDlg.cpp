...
BEGIN_MESSAGE_MAP(CSPDlg, CDialogEx)
	...
	ON_WM_MOUSEMOVE()
	ON_WM_TIMER()
	ON_BN_CLICKED(IDC_BTN_QUIT, &CSPDlg::OnBnClickedBtnQuit)
	ON_BN_CLICKED(IDC_BTN_SYS_PARA, &CSPDlg::OnBnClickedBtnSysPara)
	ON_BN_CLICKED(IDC_BTN_WORKING, &CSPDlg::OnBnClickedBtnWorking)
	ON_BN_CLICKED(IDC_BTN_MODBUS, &CSPDlg::OnBnClickedBtnModbus)
	ON_BN_CLICKED(IDC_BTN_MACHINE, &CSPDlg::OnBnClickedBtnMachine)
...
void CSPDlg::OnBnClickedBtnQuit()
{
...
void CSPDlg::OnBnClickedBtnSysPara()
{
	// TODO: 在此加入控制項告知處理常式程式碼
...
void CSPDlg::OnBnClickedBtnModbus()
{
	// TODO: 在此加入控制項告知處理常式程式碼
	m_WorkTab.ShowWindow(SW_HIDE);
	m_SystemParaTab.ShowWindow(SW_HIDE);	
...
void CSPDlg::OnBnClickedBtnMachine()
{
	// TODO: 在此加入控制項告知處理常式程式碼
	m_WorkTab.ShowWindow(SW_HIDE);
	m_SystemParaTab.ShowWindow(SW_HIDE);
...
void CSPDlg::OnNMRClickTabMain(NMHDR* pNMHDR, LRESULT* pResult)
{
	// TODO: 在此加入控制項告知處理常式程式碼
...
void CSPDlg::OnTcnSelchangeTabMain(NMHDR* pNMHDR, LRESULT* pResult)
{
	// TODO: 在此加入控制項告知處理常式程式碼
		// 獲取 Tab Control 的指針
	CTabCtrl* pTabCtrl = (CTabCtrl*)GetDlgItem(IDC_TAB_MAIN);
...
//Read System Parameters from config file
void CSPDlg::ReadSystemParametersFromConfigFile()
{
	std::string appPath;
...
bool CSPDlg::InitModbusWithRetry(const std::string& ip, int port, int slaveId, int maxRetry, int retryDelayMs)
{
